...
const PropertyPage = () => {
  ...
  const renderUnits = () => {
    ...
    return property.condo_units.map(unit => (
      ...
      <ListGroup
        ...
        className=' h-25 shadow'
      >
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          <img src={unit.image} style={{ width: '220px', height: '180px' }} />
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          <strong>unit name place holder{/*{unit.name}*/}</strong>
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
  ...
  const renderParkingSpots = () => {
    ...
    return property.parking_units.map(spot => (
      ...
      >
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          <img src={spot.image} style={{ width: '220px', height: '180px' }} />
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
        ...
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Purchase Price: ${spot.purchase_price}
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Rent Price: ${spot.rent_price}
        </ListGroup.Item>
        <ListGroup.Item>
          Extra Information: {spot.extra_information}
        </ListGroup.Item>
      </ListGroup>
    ))
  }
  ...
  const renderLockers = () => {
    ...
    return property.storage_units.map(locker => (
      ...
      >
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          <img src={locker.image} style={{ width: '220px', height: '180px' }} />
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Location: {locker.location}
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Size: {locker.size} sqft
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Purchase Price: ${locker.purchase_price}
        </ListGroup.Item>
        <ListGroup.Item style={{ marginBottom: '-10px' }}>
          Rent Price: ${locker.rent_price}
        </ListGroup.Item>
        ...
        <Col style={{ padding: '20px', overflowY: 'auto' }}>
          <Row>
            ...
            <Col className='d-flex justify-content-end'>
              <Button
                variant='primary'
                onClick={handleGoToCommonFacilities}
                style={{ marginRight: '40px' }}
                data-testid='to-common-facilities'
              >
                CommonFacilities
              </Button>
          ...
          <Row style={{ width: '300px' }}>
            ...
            <Col>
              <Button
                className='mt-2'
                variant='primary'
                onClick={handleGoToUnitCreate}
                data-testid='create-condo-unit-button'
              >
                +
              </Button>
            </Col>
          </Row>
          <div style={renderStyle}>{renderUnits()}</div>
          <Row style={{ width: '300px' }}>
            <Col>
            ...
            <Col>
              <Button
                className='mt-2'
                variant='primary'
                onClick={handleGoToParkingCreate}
                data-testid='create-parking-unit-button'
              >
                +
              </Button>
            </Col>
          </Row>
          <div style={renderStyle}>{renderParkingSpots()}</div>
          <Row style={{ width: '300px' }}>
            <Col>
            ...
            <Col>
              <Button
                className='mt-2'
                data-testid='create-storage-unit-button'
                onClick={handleGoToLockerCreate}
                variant='primary'
              >
                +
              </Button>{' '}
          ...
          <div style={renderStyle}>{renderLockers()}</div>
        </Col>
      </Row>
    </Container>
  )
