      ...
      axiosInstance
        ...
        .then(res => {
          if (res.status == 201) {
            ...
            window.alert(
              `Property profile ${formData.property_name} has been created`,
            )
            console.log(res)
      ...
      <Form className='py-5 text-dark' onSubmit={handleSubmit}>
        <Form.Group as={Col} controlId='formGridPropertyName'>
          ...
          {errors.property_name && (
            <span style={{ color: 'red' }}>{errors.property_name}</span>
          )}
        </Form.Group>
        ...
        <Form.Group as={Col} controlId='formGridPropertyAddress'>
          ...
          {errors.property_address && (
            <span style={{ color: 'red' }}>{errors.property_address}</span>
          )}
        </Form.Group>
        ...
        <Row className='mb-3'>
          <Form.Group as={Col} controlId='formGridPropertyCity'>
            ...
            {errors.property_city && (
              <span style={{ color: 'red' }}>{errors.property_city}</span>
            )}
          </Form.Group>
          <Form.Group as={Col} controlId='formGridPropertyProvince'>
            ...
            >
              <option value='British Colombia' data-testid='BC-test'>
                BC
              </option>
              <option value='Prince Edward Island' data-testid='PE-test'>
                PE
              </option>
              <option value='Nova Scotia' data-testid='NS-test'>
                NS
              </option>
              <option value='New Brunswick' data-testid='NB-test'>
                NB
              </option>
              <option value='Quebec' data-testid='QC-test'>
                QC
              </option>
              <option value='Ontario' data-testid='ON-test'>
                ON
              </option>
              <option value='Manitoba' data-testid='MB-test'>
                MB
              </option>
              <option value='Saskatchuwan' data-testid='SK-test'>
                SK
              </option>
              <option value='Alberta' data-testid='AB-test'>
                AB
              </option>
        ...
        <Row>
          <Form.Group controlId='formGridPropertyImage' className='mb-4'>
            <Form.Group as={Col} controlId='formGridPropertyFees'>
              ...
              />
              {errors.property_fee_rate && (
                <span style={{ color: 'red' }}>{errors.property_fee_rate}</span>
              )}
            </Form.Group>
            ...
            {errors.property_image && (
              <span style={{ color: 'red' }}>{errors.property_image}</span>
            )}
          </Form.Group>
        </Row>
